...
# Batch launcher for the held-sound inference experiment.
...
for index in "${!TASKS[@]}"; do
    ...
    log_file="$LOG_DIR/${reading_name}_${elec_type}_gpu${gpu_id}_hgb1_infer.log"

    echo "Starting inference $reading_name / $elec_type on GPU $gpu_id"
